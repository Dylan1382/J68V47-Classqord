...
public class L6E3 {
    public static void main(String[] args) {
        ...
        System.out.println("You have 3 lives. Let's get started!");

        for (int i = 1; i <= 10; i++) {
            int num1 = random.nextInt(10); // generates a random number between 0 and 9
            int num2 = random.nextInt(10); // generates another random number between 0 and 9
